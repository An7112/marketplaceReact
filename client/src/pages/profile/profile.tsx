...
export default function Profile() {
  ...
  useEffect(() => {
    async function getStoreInfo() {
      if (user) {
        const store = await axios.get(`https://marketplace-3lqw.onrender.com/api/stores/${user}`)
      ...
      if (user) {
        try {
          const products = await axios.get(
            `https://marketplace-3lqw.onrender.com/api/products?owner=${user}&limit=${limit}`
          )
          const productsCount = await axios.get(
            `https://marketplace-3lqw.onrender.com/api/products?owner=${user}&productCount`
          )
  ...
  async function createStore(e: any) {
    ...
    if (user != null) {
      if (storeName && storeDescription) {
        ...
        createData.append("storeId", user)
                ...
                <div className='grid-col-span-4'>
                  <div className='frame-user'>
                    ...
                    <div className='frame-username'>
                      ...
                      {/* <p className='text-base'>thanhan7112@gmail.com</p> */}
                    </div>
                    ...
                    <div className='upload-dsc'>
                      <div className="form-user-info">
                        ...
                        <div className='div-label-input'>
                          ...
                          <input defaultValue={user && user} className='input' id='Chain' type="text" placeholder="id" required
                            value={user}
                            readOnly
                          />
                        </div>
